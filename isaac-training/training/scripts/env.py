...
class NavigationEnv(IsaacEnv):
    ...
    def _compute_state_and_obs(self):
        ...
        # # -----------------Training Stats-----------------
        # Collision source breakdown. A simultaneous static+dynamic hit on the
        # same sim step is virtually never observed (episode terminates on the
        # first contact), so we only attribute by which source was active.
        # Note: in the rare simultaneous case, both flags are set.
